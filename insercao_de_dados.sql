...
-- Limpeza prévia para evitar erros de duplicidade
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE tbl_leituras;
TRUNCATE TABLE tbl_avaliacoes;
TRUNCATE TABLE livro_genero;
TRUNCATE TABLE livro_autor;
TRUNCATE TABLE meta_livro;
TRUNCATE TABLE tbl_metas_leitura;
TRUNCATE TABLE tbl_generos;
TRUNCATE TABLE tbl_autor;
TRUNCATE TABLE tbl_livros;
TRUNCATE TABLE participantes;
TRUNCATE TABLE tbl_grupos;
