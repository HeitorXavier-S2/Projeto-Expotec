CREATE DATABASE IF NOT EXISTS orbitlit_db;
USE orbitlit_db;
...
-- TABELAS DEPENDENTES (Com 1 ou 2 Chaves Estrangeiras)
...
CREATE TABLE IF NOT EXISTS livro_autor (
    ...
    FOREIGN KEY (id_livro) REFERENCES tbl_livros(id_livro) ON DELETE CASCADE,
    FOREIGN KEY (id_autor) REFERENCES tbl_autor(id_autor) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS livro_genero (
    ...
    FOREIGN KEY (id_livro) REFERENCES tbl_livros(id_livro) ON DELETE CASCADE,
    FOREIGN KEY (id_genero) REFERENCES tbl_generos(id_genero) ON DELETE CASCADE
);